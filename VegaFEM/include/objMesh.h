...
/*
 Fei Zhu add following methods:
     int getVertexNeighborFaceNum(unsigned int vertexIndex);
     const Face *getVertexNeighborFaceHandle(unsigned int vertexIndex,unsigned int faceNeighborIndex)

 2013 PKU, zhuf@graphics.pku.edu.cn
*/
...
public:
  ...
  int getVertexNeighborFaceNum(unsigned int vertexIndex);//Fei Zhu: return neighbor face number of a vertex, must call "buildVertexFaceNeighbors" first
  const Face *getVertexNeighborFaceHandle(unsigned int vertexIndex,unsigned int faceNeighborIndex);//Fei Zhu: return face handle of the 'faceNeighborIndex' neighbor face of 'vertexIndex' vertex
                                                                                                                                                                                             //must call "buildVertexFaceNeighbors" first
